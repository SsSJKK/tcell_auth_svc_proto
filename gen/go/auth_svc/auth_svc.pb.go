...
var file_auth_svc_auth_svc_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0x2a, 0x0a, 0x10, 0x47,
	...
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2b, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x38, 0x0a, 0x11, 0x43,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2d, 0x0a, 0x12, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x54, 0x6f,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0x57, 0x0a,
	...
	0x6e, 0x32, 0xa9, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65,
	...
	0x12, 0x3b, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x17, 0x2e, 0x61,
...
var file_auth_svc_auth_svc_proto_depIdxs = []int32{
	...
	5, // 4: auth.Auth.GetToken:input_type -> auth.CheckTokenRequest
	3, // 5: auth.Auth.Register:output_type -> auth.RegisterResponse
	8, // 6: auth.Auth.Login:output_type -> auth.LoginResponse
	9, // 7: auth.Auth.Refresh:output_type -> auth.RefreshResponse
	6, // 8: auth.Auth.CheckToken:output_type -> auth.CheckTokenResponse
	2, // 9: auth.Auth.GetToken:output_type -> auth.GetTokenResponse
