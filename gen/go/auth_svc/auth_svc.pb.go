...
var file_auth_svc_auth_svc_proto_rawDesc = []byte{
	...
	0x33, 0x0a, 0x0e, 0x53, 0x69, 0x67, 0x6e, 0x4f, 0x75, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xb5, 0x03, 0x0a, 0x04, 0x41,
	...
	0x73, 0x65, 0x42, 0x16, 0x5a, 0x14, 0x73, 0x73, 0x73, 0x6a, 0x6b, 0x6b, 0x2e, 0x61, 0x75, 0x74,
	0x68, 0x2e, 0x76, 0x31, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_auth_svc_auth_svc_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_auth_svc_auth_svc_proto_goTypes = []interface{}{
	(*SignOutRequest)(nil),         // 0: auth.SignOutRequest
	(*SignOutResponse)(nil),        // 1: auth.SignOutResponse
	(*SignUpRequest)(nil),          // 2: auth.SignUpRequest
	(*TakePinRequest)(nil),         // 3: auth.TakePinRequest
	...
	(*CheckPermissonRequest)(nil),  // 9: auth.CheckPermissonRequest
	(*CheckPermissonResponse)(nil), // 10: auth.CheckPermissonResponse
	(*TakePinResponse)(nil),        // 11: auth.TakePinResponse
	(*SignInRequest)(nil),          // 12: auth.SignInRequest
	(*SignInResponse)(nil),         // 13: auth.SignInResponse
}
var file_auth_svc_auth_svc_proto_depIdxs = []int32{
	2,  // 0: auth.Auth.SignUp:input_type -> auth.SignUpRequest
	12, // 1: auth.Auth.SignIn:input_type -> auth.SignInRequest
	5,  // 2: auth.Auth.RefreshToken:input_type -> auth.RefreshTokenRequest
	7,  // 3: auth.Auth.CheckToken:input_type -> auth.CheckTokenRequest
	9,  // 4: auth.Auth.CheckPermisson:input_type -> auth.CheckPermissonRequest
	3,  // 5: auth.Auth.TakePin:input_type -> auth.TakePinRequest
	0,  // 6: auth.Auth.SignOut:input_type -> auth.SignOutRequest
	4,  // 7: auth.Auth.SignUp:output_type -> auth.SignUpResponse
	13, // 8: auth.Auth.SignIn:output_type -> auth.SignInResponse
	6,  // 9: auth.Auth.RefreshToken:output_type -> auth.RefreshTokenResponse
	8,  // 10: auth.Auth.CheckToken:output_type -> auth.CheckTokenResponse
	10, // 11: auth.Auth.CheckPermisson:output_type -> auth.CheckPermissonResponse
	11, // 12: auth.Auth.TakePin:output_type -> auth.TakePinResponse
	1,  // 13: auth.Auth.SignOut:output_type -> auth.SignOutResponse
